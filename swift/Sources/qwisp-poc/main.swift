...
if CommandLine.arguments.contains("stream") {
    ...
    let runners: [(String, (String, String) throws -> String)] = [
        ...
        ("raw-stream-prof",       { md, rp in try RawStreamProf.run(modelDir: md, refPath: rp) }),
        ...
        ("verify-gather-bench",   { md, _ in try StreamingMoEValidation.runVerifyGatherBench(modelDir: md) }),
