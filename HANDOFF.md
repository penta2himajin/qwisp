...
- Lean-certified (qwisp-lean `98e20bd`, `Qwispmath/LaneCeiling.lean`, no sorry): efficiency ∈ (0.82, 0.83) exact; aggregate ≤ 233 tok/s for ALL B (affine floor, measured min marginal 4.3ms/lane); raw qmv row marginals [18.9,20]µs ≡ MLX band [19,21]µs; tiled ≥7x/rows_b ≥3.9x NO-GO ratios; Stage-1b recovery < +2 tok/s; W+B·S IO floor grounded per lane on T4 `read_lower_bound` (`lane_state_read_floor`).
